...
describe("TimelineStateManager", () => {
	describe("cache invalidation", () => {
		...
		it.each([EditEvent.ClipGenerationStarted, EditEvent.ClipGenerationCompleted, EditEvent.ClipGenerationFailed])(
		...
		it("unsubscribes from events on dispose", () => {
			...
			expect(edit.events.off).toHaveBeenCalledWith(EditEvent.ClipGenerationStarted, expect.any(Function));
			expect(edit.events.off).toHaveBeenCalledWith(EditEvent.ClipGenerationCompleted, expect.any(Function));
			expect(edit.events.off).toHaveBeenCalledWith(EditEvent.ClipGenerationFailed, expect.any(Function));
