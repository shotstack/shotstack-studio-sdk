...
export class TextToolbar extends BaseToolbar {
	...
	private bindElements(): void {
		...
		// Transition (popup container for composite)
		...
		// Effect (popup container for composite)
	...
	private mountCompositePanels(): void {
		...
		// EffectPanel - replaces ~120 lines of effect handling
		if (this.effectPopup) {
